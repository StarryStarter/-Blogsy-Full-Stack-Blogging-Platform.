    ...
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
      <div className="text-center mt-20 mb-8">
        <div className="inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm">
          ...
          <img src={assets.star_icon} className="w-2.5" alt="AI star logo" />
        </div>
        ...
        <p className="my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500">
          Use this space to express your thoughts clearly, share what truly
          matters to you, and write without restraint. Whether it’s a sentence
          or a story, this is where it all begins.
        </p>
